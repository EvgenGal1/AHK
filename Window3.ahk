...
if (MonitorCount > 1) {
	...
	if WinExist("ahk_exe " WindowRemoteExe) {
		...
		WinMove(A_ScreenWidth - (A_ScreenWidth * 0.2), 0, A_ScreenWidth * 0.2, A_ScreenHeight - 40, "ahk_exe " WindowRemoteExe)		; откр.в раб.область на 2-ом мониторе на 20% с ПРАВО
	}
	Sleep 250
}